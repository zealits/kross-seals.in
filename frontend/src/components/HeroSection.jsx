      ...
      case '/':
        return (
          ...
          <div className="relative flex items-center justify-center h-full text-center text-white p-4">
            <div>
              <h1 className="text-5xl font-bold mb-4">Welcome to Kross International</h1>
              <p className="text-lg mb-8">Leading Manufacturer of High-Quality Oil Seals for Over 35 Years</p>
