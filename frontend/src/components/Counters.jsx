...
const Counter = ({ end, duration, label, Icon }) => {
  ...
  return (
    <div ref={ref} className="flex items-center space-x-4 text-center md:text-left">
      <Icon className="text-primary text-3xl md:text-4xl" />
      <div className="text-left">
        <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-primary">{count}+</h3>
...
const Counters = () => {
  return (
    <section className="py-8 md:py-12 lg:py-16 bg-light-gray">
