...
const ContactUs = () => {
  ...
  {/* Contact Form and Image in the Same Div */}
  <div className="lg:w-full flex flex-col lg:flex-row bg-white shadow-lg rounded-lg p-6">
  ...
  <div className="bg-white shadow-lg rounded-lg p-6 flex flex-col lg:flex-row">
    <div className="lg:w-1/2 lg:pr-4">
      ...
      <p className="mb-4">
        <a href="mailto:info@krossinternational.com" className="text-primary hover:underline">info@krossinternational.com</a>
      </p>
